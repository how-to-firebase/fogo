...
const ImagesView = connect('environment,searchResults,isAdmin,searching', actions)(
  ({ environment, searchResults, isAdmin, searching }) => (
    <div id="images-view" class={style.imagesView} view="images">
      <h1 class={style.header}>
        {(searching && 'Search results') || 'All images'}
        {searchResults && ` (${searchResults.hits.length}/${searchResults.nbHits})`}
      </h1>
